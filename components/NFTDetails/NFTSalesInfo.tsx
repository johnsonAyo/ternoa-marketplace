...
const style = {
  wrapper: ` flex flex-col divide-y border dark:divide-black
     dark:rounded-lg dark:border-black`,
  ...
  button: `flex w-[14rem] items-center cursor-pointer justify-center 
  space-x-4 rounded-lg py-2 text-white`,
  purchaseButton: `bg-blue-500`,
  offerButton: `border border-black bg-red-500`,
  buttonIcon: `h-6 w-6`,
};

const NFTSalesInfo = ({ price, deleteNft }: any) => {
  return (
      ...
      <div className={style.header}>
        <div className={style.headerContent}>
          ...
          <div className={style.greyText}>
            Sales ends june 1, 2022 at 8:26 GNT-7
          </div>
        </div>
      ...
      <div className={style.mainContainer}>
        <div className={style.priceInfoContainer}>
          ...
          <div className={style.priceContainer}>
            <Image src="/weth-logo.svg" width={24} height={24} alt="" />
